...
echo form_open('leaves/createfreeleave', $attributes) ?>
    ...
    <select class="input-xxlarge" disabled name="type" id="type">
    ...
    <input type="text" class="input-xxlarge" name="viz_startdate" id="viz_startdate" value="<?php echo set_value('startdate'); ?>" autocomplete="off" />
    <input type="hidden" class="input-xxlarge" name="startdate" id="startdate" /><br />

    <label for="viz_enddate"><?php echo lang('leaves_create_field_end');?></label>
    <input type="text" class="input-xxlarge" name="viz_enddate" id="viz_enddate" value="<?php echo set_value('enddate'); ?>" autocomplete="off" />
    <input type="hidden" class="input-xxlarge" name="enddate" id="enddate" /><br />

    <?php if ($this->config->item('disable_edit_leave_duration') == TRUE) { ?>
    <input type="text" style="display:none;" class="input-xxlarge" name="duration" id="duration" value="<?php echo set_value('duration'); ?>" readonly />
    <?php } else { ?>
    <input type="text" style="display:none;" class="input-xxlarge" name="duration" id="duration" value="<?php echo set_value('duration'); ?>" />
    <?php } ?>
    <label for="dayFree"><?php echo lang('dayFree');?> <span id="dayFree"></span></label>
    <select class="input-xxlarge" name="dayFree" id="dayFree">
    ...
    &nbsp;&nbsp;
    <button id="btn-request" type="button" class="btn btn-primary "><i class="mdi mdi-check"></i>&nbsp; <?php echo lang('Requested');?></button>
    <button name="status" id="btn-request-valid" style="display: none;" value="2" type="submit" class="btn btn-primary "><i class="mdi mdi-check"></i>&nbsp; <?php echo lang('Requested');?></button>
    <br/><br/>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/lms/leave.edit-0.7.0.free_day.js" type="text/javascript"></script>
