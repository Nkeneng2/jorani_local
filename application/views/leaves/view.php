...
<div class="row-fluid">
    ...
    <select name="startdatetype" style="<?php echo $leave['free_day'] ? 'display: none;' : ''; ?>" readonly>
    ...
    <select name="enddatetype" style="<?php echo $leave['free_day'] ? 'display: none;' : ''; ?>" readonly>
        <option selected><?php echo lang($leave['enddatetype']); ?></option>
    </select><br />

    <label style="<?php echo $leave['free_day'] ? 'display: none;' : ''; ?>" for="duration"><?php echo lang('leaves_view_field_duration');?></label>
    <input type="text" name="duration" style="<?php echo $leave['free_day'] ? 'display: none;' : ''; ?>" value="<?php echo $leave['duration']; ?>" readonly />
    ...
    <label style="<?php echo $leave['free_day'] ? 'display: none;' : ''; ?>" for="cause"><?php echo lang('leaves_view_field_cause');?></label>
    <textarea style="<?php echo $leave['free_day'] ? 'display: none;' : ''; ?>" name="cause" readonly><?php echo $leave['cause']; ?></textarea>
