...
<?php foreach ($leaves as $leave):
    ...
    <tr style = "<?php echo $leave['free_day'] ? 'background:#D9FCD8' : ''; ?>">
        ...
        <td style = "<?php echo $leave['free_day'] ? 'background:#D9FCD8' : ''; ?>" data-order="<?php echo $tmpStartDate; ?>"><?php echo $freeday; ?></td>
...
<div class="row-fluid">
    <div class="span12">
      ...
      &nbsp;&nbsp; -->
      <a href="<?php echo base_url();?>leaves" class="btn btn-secondary"><i class="mdi mdi-chevron-left"></i>&nbsp; <?php echo lang('prev');?></a>
      &nbsp;&nbsp;
