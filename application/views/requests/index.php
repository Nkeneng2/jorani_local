...
<div class="">
    <div class="" style="float:left; padding-left:5%; padding-top:6px;" id="selectItem"></div>
    <div class="" style="float:right; display:none;" id="btnAction">
        <button type="button" id="btnAccepted" class="btn btn-success" style="margin-right: 20px;"><?php echo lang('Accepted');?></button>
        <button type="button" id="btnRejected" class="btn btn-danger"><?php echo lang('Rejected');?></button>
    </div>
</div>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="leaves" width="100%">
    <thead>
        <tr>
        <th><input title="<?php echo lang('check_all');?>" type="checkbox" name="select_all" value="1" id="example-select-all"></th>
        ...
        <?php if(!$request['parent_leave_id']) : ?>
            <tr style = "<?php echo $request['free_day'] ? 'background:#D9FCD8' : ''; ?>">
                ...
                <td data-order="<?php echo $request['leave_id']; ?>">
                    ...
                    <?php if ($this->config->item('enable_history') === TRUE) { ?>
                    &nbsp;
                    <a href="<?php echo base_url();?><?php if($request['parent_leave'] == 1) : ?>requests/details/<?php echo $request['leave_id']; ?>/true<?php else : ?>leaves/leaves/<?php echo $request['leave_id']; ?><?php endif; ?>" title="<?php echo lang('requests_index_thead_tip_view');?>"><i class="mdi mdi-eye nolink"></i></a>
                    &nbsp;
    ...
    <tr style = "<?php echo $request['free_day'] ? 'background:#D9FCD8' : ''; ?>">
        ...
        <td data-order="<?php echo $request['leave_id']; ?>">
            ...
            <div class="pull-right">
              ...
              <?php if ($this->config->item('enable_history') === TRUE) { ?>
              &nbsp;
              <a href="<?php echo base_url();?><?php if($request['parent_leave'] == 1) : ?>requests/details/<?php echo $request['leave_id']; ?><?php else : ?>leaves/leaves/<?php echo $request['leave_id']; ?><?php endif; ?>" title="<?php echo lang('requests_index_thead_tip_view');?>"><i class="mdi mdi-eye nolink"></i></a>
              &nbsp;
              <a href="#" class="show-history" data-id="<?php echo $request['leave_id'];?>" title="<?php echo lang('requests_index_thead_tip_history');?>"><i class="mdi mdi-history nolink"></i></a>
              <?php } ?>
            </div>
