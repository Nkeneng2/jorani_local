...
<div class="row-fluid">
    <div class="span12">
        <a href="<?php echo base_url();?>requests" class="btn btn-secondary"><i class="mdi mdi-chevron-left"></i>&nbsp; <?php echo lang('prev');?></a>
        &nbsp;&nbsp;
        ...
        &nbsp;&nbsp; -->
        <a href="<?php echo base_url();?>requests/details/filter/<?php echo $id_parent_leave; ?>/all" class="btn btn-primary"><i class="mdi mdi-filter-remove"></i>&nbsp; <?php echo lang('requests_index_button_show_all');?></a>
        &nbsp;&nbsp;
        <a href="<?php echo base_url();?>requests/details/<?php echo $id_parent_leave; ?>" class="btn btn-primary"><i class="mdi mdi-filter"></i>&nbsp; <?php echo lang('requests_index_button_show_pending');?></a>
        &nbsp;&nbsp;
